...
class ChainTest extends \PHPUnit_Framework_TestCase
{
    ...
    function test_chain_basic()
    {
        ...
        $res2 = clone( $this->res );
        $res3 = clone( $this->res );
        $this->chain->addResponsible( $res1 );
        $this->chain->addResponsible( $res2 );
        $this->chain->addResponsible( $res3 );
    ...
    function test_chain_with_uri()
    {
        ...
        $res2 = clone( $this->res );
        $res3 = clone( $this->res );
        $this->chain->addResponsible( $res1, '/not' );
        $this->chain->addResponsible( $res2, '/path' );
        $this->chain->addResponsible( $res3 );
